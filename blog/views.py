...
def index(request):
    popular_posts = Post.objects.prefetch_related('author').annotate(likes_count=Count('likes', distinct=True)).annotate(comments_amount=Count('comments', distinct=True))
